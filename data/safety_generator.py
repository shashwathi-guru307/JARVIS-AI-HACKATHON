...
def generate_safety() -> dict:
    ...
    profiles = {
        "normal":               {"present": True,  "activity": 0.75, "inactivity": 0,    "env_risk": "NORMAL", "prox": "NORMAL", "fatigue": "NONE",     "emergency": "NONE"},
        "inactive":             {"present": True,  "activity": 0.05, "inactivity": 480,  "env_risk": "NORMAL", "prox": "NORMAL", "fatigue": "POSSIBLE", "emergency": "NONE"},
        "environmental_warning":{"present": True,  "activity": 0.60, "inactivity": 0,    "env_risk": "HIGH",   "prox": "NORMAL", "fatigue": "NONE",     "emergency": "NONE"},
        "proximity_warning":    {"present": True,  "activity": 0.70, "inactivity": 0,    "env_risk": "MEDIUM", "prox": "HIGH",   "fatigue": "NONE",     "emergency": "NONE"},
        "fatigue_pattern":      {"present": True,  "activity": 0.15, "inactivity": 720,  "env_risk": "LOW",    "prox": "NORMAL", "fatigue": "HIGH",     "emergency": "NONE"},
